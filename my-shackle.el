  ...
  (progn
    ...
    (setq shackle-rules
          '(
            ...
            ;; ("*Help*"  :select nil :align my-shackle-sensible-alignment)
            ;; ("*Help*" :other t :select nil :align my-shackle-sensible-alignment)
            ...
            ;; ("*Help*" :other t :select nil :same nil :align my-shackle-sensible-alignment :size 0.5)
            ("\\*helpful function.*" :regexp t :other t :select nil :same nil :align my-shackle-sensible-alignment :size 0.5)
            ;; ("*Help*" :other t :select nil :same nil :align my-shackle-sensible-alignment :size 0.25)
